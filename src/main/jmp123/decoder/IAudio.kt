...
interface IAudio {
     ...
     * @see Header
     */
    fun open(h: Header, artist: String): Boolean
     ...
     */
    fun write(b: ByteArray, size: Int): Int
     ...
     */
    fun refreshMessage(msg: String)
    //=====================添加方法========================
    /**
     * 添加音量大小的控制
     * @param gain 音量的大小
     */
    fun setLineGain(gain: Float)
